...
export const projects = [
    ...
    },
    {
        title: "Edulearn",
        tagline:
            "Empowering education with an interactive and responsive platform.",
        description:
    ...
    },
    {
        title: "Envision",
        tagline:
            "Stream your favorites with ease on our comprehensive entertainment hub.",
        description:
    ...
    },
    {
        title: "Wor-k-Lock",
        tagline:
            "Book your perfect workspace instantly with our user-friendly platform.",
        description:
