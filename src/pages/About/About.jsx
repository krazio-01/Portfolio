...
const skillsData = [
    { name: 'React.js', category: 'frameworks', icon: <FaReact color="#61DAFB" /> },
    { name: 'Next.js', category: 'frameworks', icon: <RiNextjsLine color="#ffffff" /> },
    { name: 'Angular', category: 'frameworks', icon: <FaAngular color="#DD0031" /> },
    { name: 'Node.js', category: 'frameworks', icon: <FaNodeJs color="#3c873a" /> },
    { name: 'Express.js', category: 'frameworks', icon: <SiExpress color="#ffffff" /> },
    { name: 'Zustand', category: 'frameworks', icon: <TbBoxModel color="#ec5990" /> },
    { name: 'Framer Motion', category: 'frameworks', icon: <FiFramer color="#ffffff" /> },
    { name: 'Socket.io', category: 'realtime', icon: <SiSocketdotio color="#ffffff" /> },
    { name: 'WebRTC', category: 'realtime', icon: <SiWebrtc color="#ffffff" /> },
    { name: 'WebSockets', category: 'realtime', icon: <FaNetworkWired color="#005C8A" /> },
    { name: 'REST APIs', category: 'realtime', icon: <TbApi color="#007ACC" /> },
    { name: 'JWT Auth', category: 'realtime', icon: <SiJsonwebtokens color="#ffffff" /> },
    { name: 'MongoDB', category: 'databases', icon: <BiLogoMongodb color="#47A248" /> },
    { name: 'Redis', category: 'databases', icon: <SiRedis color="#DC382D" /> },
    { name: 'Cloudinary', category: 'databases', icon: <SiCloudinary color="#3448C5" /> },
    { name: 'Postman', category: 'databases', icon: <SiPostman color="#FF6C37" /> },
    { name: 'Git', category: 'databases', icon: <FaGitAlt color="#f1502f" /> },
    { name: 'JavaScript', category: 'languages', icon: <IoLogoJavascript color="#F7DF1E" /> },
    { name: 'TypeScript', category: 'languages', icon: <BiLogoTypescript color="#3178C6" /> },
    { name: 'Java', category: 'languages', icon: <FaJava color="#f89820" /> },
    { name: 'C++', category: 'languages', icon: <TbBrandCpp color="#3178C6" /> },
];

const categories = [
    { id: 'all', label: 'All Skills' },
    { id: 'frameworks', label: 'Frameworks & Libraries' },
    { id: 'realtime', label: 'Real-Time & APIs' },
